...
class Config:
    ...
    OUTPUT_DIR = "outputs"
    FULL_RESULTS = "phase1_sentiment_results.csv"
    NEGATIVE_COMMENTS = "phase2_input_negative_comments.csv"
    CONFUSION_MATRIX_IMG = "phase1_confusion_matrix.png"
    ACCURACY_REPORT = "phase1_accuracy_report.txt"
...
def load_model():
    print("\n" + "="*70)
    print("STEP 3: LOADING BERTWEET MODEL")
    print("="*70)
...
def analyze_sentiment(df, tokenizer, model, labels):
    print("\n" + "="*70)
    print("STEP 4: ANALYZING SENTIMENT WITH AI")
    print("="*70)
...
def evaluate_model(df):
    ...
    print(f"   (BERTweet correctly predicted {accuracy:.2%} of comments)")
...
def save_results(df, metrics):
    ...
    with open(report_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PHASE 1: SENTIMENT ANALYSIS ACCURACY REPORT\n")
        f.write("="*70 + "\n\n")
...
def display_summary(df, metrics, start_time):
    ...
    print("\n" + "="*70)
    print("Phase 1 sentiment analysis completed successfully!")
    print("="*70 + "\n")
