...
class Config:
    ...
    OUTPUT_DIR = "outputs"
    FULL_RESULTS = "phase1_sentiment_results_roberta.csv"
    NEGATIVE_COMMENTS = "phase2_input_negative_comments_roberta.csv"
    CONFUSION_MATRIX_IMG = "phase1_confusion_matrix_roberta.png"
    ACCURACY_REPORT = "phase1_accuracy_report_roberta.txt"
...
def analyze_sentiment(df, tokenizer, model, labels):
    ...
    print("   This will take 7-8 minutes...")
...
def evaluate_model(df):
    ...
    plt.title('Sentiment Analysis Confusion Matrix\nRoBERTa-Twitter on YouTube Comments')
...
def save_results(df, metrics):
    ...
    with open(report_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PHASE 1: SENTIMENT ANALYSIS ACCURACY REPORT - ROBERTA\n")
        f.write("="*70 + "\n\n")
...
def display_summary(df, metrics, start_time):
    print("\n" + "="*70)
    print("ROBERTA PHASE 1 COMPLETE!")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("RoBERTa sentiment analysis completed successfully!")
    print("Run 'python compare_all_models.py' to compare with BERTweet results")
    print("="*70 + "\n")
...
def main():
    ...
    try:
        ...
        print(f"\nERROR: {str(e)}")
        print("\nTip: Make sure YoutubeCommentsDataSet_Balanced.csv is in the same folder!")
        raise
